package com.aplikasi.gizilo.utils
...
class ImageClassifierHelper(
    ...
    private val modelName: String = "resnet50v2_model_metadata.tflite",
    val context: Context,
    ...
    fun classifyImage(imageUri: Uri) {
        ...
        val imageProcessor = ImageProcessor.Builder()
            .add(ResizeOp(229, 229, ResizeOp.ResizeMethod.NEAREST_NEIGHBOR))
        ...
        inference -= SystemClock.uptimeMillis()
